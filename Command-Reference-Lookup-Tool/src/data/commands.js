...
export const SAMPLE_COMMANDS = [
  {
    ...
    description: 'Creates shortcuts for commonly used commands, improving efficiency and reducing typing errors',
    safetyLevel: 'safe',
    platforms: [
      { 
        id: 'linux', 
    ...
    examples: [
      { 
        ...
        code: "alias ll='ls -la'",
        description: 'Create a shortcut for listing files in long format with hidden files',
  ...
  },
  {
    ...
    description: 'Display information about files and directories in various formats and with different levels of detail',
    safetyLevel: 'safe',
    platforms: [
      { 
        id: 'linux', 
    ...
    examples: [
      ...
      { 
        ...
        code: "ls -la",
        description: 'Show all files with detailed information including permissions and size',
      ...
      { 
        ...
        output: '-rw-r--r-- 1 user user 1.2K Jan 15 10:30 file.txt\n-rw-r--r-- 1 user user 2.5M Jan 15 09:15 image.jpg'
      }
    ],
    relatedCommands: [
  ...
  },
  {
    ...
    description: 'Track changes in files and coordinate work on those files among multiple people',
    safetyLevel: 'caution',
    platforms: [
      { 
        id: 'linux', 
    ...
    syntax: 'git [--version] [--help] [-C <path>] <command> [<args>]',
    flags: [
      {
        flag: '--version',
  ...
  },
  {
    ...
    examples: [
      { code: "ansible all -m ping # Test connectivity" },
      { code: "ansible-playbook site.yml # Run playbook" },
      { code: "ansible-vault create secrets.yml # Create encrypted file" }
    ]
  },
  {
    name: 'docker',
    ...
    examples: [
      ...
      { code: "docker build -t myapp . # Build image" },
      { code: "docker run -p 8080:80 myapp # Run container" },
  ...
  },
  {
    ...
    examples: [
      ...
      { 
        ...
        output: 'rm: remove regular file \'app.log\'? y\nrm: remove regular file \'error.log\'? n'
      }
    ],
    relatedCommands: [
